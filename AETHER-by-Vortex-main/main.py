...
async def main():
    ...
    print("=" * 60)
    print("  Agents: Watcher • Criticality • Identifier • FixFinder • Simulator • Validator • Executor • PostMonitor • RAG")
    print(f"  AI Mode Hierarchy: Tier 1 (Ollama Local) -> Tier 2 (Groq Cloud) -> Tier 3 (Rule Engine)")
    print("=" * 60 + "\n")
